...
namespace SFA.DAS.Payments.Audit.ArchiveService.V1.Helper
{
    public static class StatusHelper
    {
        ...
        {
            return new EntityId(nameof(HandleCurrentJobId.Handle), HandleCurrentJobId.PeriodEndArchiveEntityName);
        }

        //public static async Task UpdateCurrentJobStatus(IDurableEntityClient entityClient, ArchiveRunInformation runInformation)
        //{
