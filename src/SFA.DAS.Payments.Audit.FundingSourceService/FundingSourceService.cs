...
{
    public class FundingSourceService : StatelessService
    {
        ...
        public FundingSourceService(StatelessServiceContext context, IPaymentLogger logger, ILifetimeScope lifetimeScope)
            : base(context)
        {
