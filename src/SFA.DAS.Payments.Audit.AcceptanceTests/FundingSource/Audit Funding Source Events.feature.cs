...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Funding Source Events Calculated")]
        public virtual void FundingSourceEventsCalculated()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Funding Source Events Calculated", null, ((string[])(null)));
#line 7
...
#line hidden
            ...
            table5.AddRow(new string[] {
                        ...
                        "Act1"});
#line 8
 testRunner.Given("the funding source service has calculated the following payments", ((string)(null)), table5, "Given ");
#line 14
